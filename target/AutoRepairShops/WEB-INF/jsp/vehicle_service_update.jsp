		...
		<div class="row">
			<div class="col-md-9 margin-bottom-15">
				...
				<form:form modelAttribute="service" method="POST"
					action="${pageContext.servletContext.contextPath }/services/handleUpdate">
					...
					<form:input path="details" class="form-control margin-bottom-15" />
					<form:errors path="details" />

					<button type="submit" class="btn btn-primary"><spring:message
							code="vehicle_service_add.update" /></button>
