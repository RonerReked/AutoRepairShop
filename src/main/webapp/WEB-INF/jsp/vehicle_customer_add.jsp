		...
		<div class="row">
			<div class="col-md-9 margin-bottom-15">
				...
				<form:form modelAttribute="customer" method="POST"
					action="${pageContext.servletContext.contextPath }/customers/handleAdd">
					...
					<br />
					<label for="firstName" class="control-label"><spring:message
							code="vehicle_customer_add.contactdetails" /></label>
					...
					<button type="submit" class="btn btn-primary"><spring:message code="vehicle_customer_add.save"/></button>
